...
public class AdminDao implements IAdminDao {
	...
	private static final String FETCH_EMPLOYEES="SELECT empId,fName,mName,lName,emailId from employee e";
			...
			if(compare(rs.getString("e.mName"))) {
				...
				if(compare(rs.getString("e.lName"))) {
					...
					groupEmpId = groupEmpId + " " +
							...
							(rs.getString("e.fName")+" "+rs.getString("e.mName")+" "+rs.getString("e.lName"));
				} 
				else {
